...
![Minecraft FluxCraft Logo](images/fluxcraft.png)

## Quick Start

1. Download the [latest release JAR file](https://github.com/jforge/FluxCraft/releases/latest) and place it in your `plugins` folder.
2. Restart your server to enable the plugin.
3. For detailed configuration and usage instructions, see the [User Guide](USER_GUIDE.md).
